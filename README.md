...
Run via File > Scripts > Browse > `ps_storyboard_exporter.jsx`. Select an output folder. One PNG is exported per PSD folder. You'll be prompted before any existing files are overwritten.
